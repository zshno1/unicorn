<template>
    ...
    <nut-form>
        <nut-form-item label="金额" label-align="center">
            <input v-model="basicData.money"  placeholder="请输入金额" type="number" clearable
                :border="false" />
        </nut-form-item>
        <nut-form-item label="年化率" label-align="center">
            <input v-model="basicData.rate"  placeholder="请输入年化率" type="number" clearable
                :border="false" />%
        </nut-form-item>
        <nut-form-item label="天数" label-align="center">
            <input v-model="basicData.day"  placeholder="请输入天数" type="number" clearable
                :border="false" />
        </nut-form-item>
        <nut-cell>
            预计收益：
